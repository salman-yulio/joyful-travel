...
if (isset($_POST["submit"])){
  ...
  if (update($_POST)>0){
      echo
      "<script>
          alert('Tanggal Keberangkatan Berhasil Diubah');
      ...
      echo 
      "<script>
          alert('Tanggal Keberangkatan Gagal Diubah');
      </script>";
  }
} 
...
<div class="col-md-4">
    ...
    <input disabled name="nama" type="text" class="form-control" id="nama" value="<?= $dp["nama"]; ?>" required>
  </div>

  <div class="col-md-3">
    <label for="jml" class="form-label">Destinasi</label>
    <select name="jml" class="form-select" id="jml" required>
      <option disabled selected><?= $dp["jml"]; ?></option>
    </select>
  </div>
  ...
  <div class="col-md-3">
    ...
    <input disabled name="no" type="no" class="form-control" id="no" value="<?= $dp["no"]; ?>" required>
  </div>

  <div class="col-12">
    <button class="btn btn-primary" name="submit" type="submit">Simpan</button>
    <a href="guest.php" class="btn btn-primary" >Batal</a>
  </div>
</form>
</div>
</div>
